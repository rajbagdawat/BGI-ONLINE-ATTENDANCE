...
public class Computer_Graphics_CSA_1stYE extends AppCompatActivity {

    TextView showdate;
    ImageView sldate;
    int y,m,d;
    @SuppressLint("MissingInflatedId")
    ActivityComputerGraphicsCsa1stYeBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_computer_graphics_csa1st_ye);
            binding =  ActivityComputerGraphicsCsa1stYeBinding.inflate(getLayoutInflater());
            setContentView(R.layout.activity_computer_graphics_csa1st_ye);
        ...
        sldate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog g = new DatePickerDialog(Computer_Graphics_CSA_1stYE.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            ListAdapter listAdapter = new ListAdapter(Computer_Graphics_CSA_1stYE.this, userArrayList);
            ...
            binding.listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent i = new Intent(Computer_Graphics_CSA_1stYE.this, Userr_Activity.class);
