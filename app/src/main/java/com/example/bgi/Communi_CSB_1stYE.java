...
import com.example.bgi.databinding.ActivityCommuniCsb1stYeBinding;

import java.util.ArrayList;
import java.util.Calendar;

public class Communi_CSB_1stYE extends AppCompatActivity {

    TextView showdate;
    ImageView sldate;
    int y,m,d;
    @SuppressLint("MissingInflatedId")
    ActivityCommuniCsb1stYeBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_communi_csb1st_ye);
        binding = ActivityCommuniCsb1stYeBinding.inflate(getLayoutInflater());
        ...
        sldate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog g = new DatePickerDialog(Communi_CSB_1stYE.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int y, int m, int d) {
                        ...
                        ListAdapter listAdapter = new ListAdapter(Communi_CSB_1stYE.this, userArrayList);
                        binding.listview.setAdapter(listAdapter);
                        binding.listview.setClickable(true);
                        binding.listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            @Override
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                Intent i = new Intent(Communi_CSB_1stYE.this, Userr_Activity.class);
