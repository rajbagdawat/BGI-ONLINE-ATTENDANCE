...
public class SDBCE_SecondY_CS_B_ListView extends AppCompatActivity {

    ActivitySdbceSecondYcsBlistViewBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sdbce_second_ycs_blist_view);
        binding =    ActivitySdbceSecondYcsBlistViewBinding.inflate(getLayoutInflater());
        ...
        ListAdapter listAdapter = new ListAdapter(SDBCE_SecondY_CS_B_ListView.this, userArrayList);
        ...
        binding.listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(SDBCE_SecondY_CS_B_ListView.this, Userr_Activity.class);
