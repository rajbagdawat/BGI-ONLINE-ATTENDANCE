...
public class QA_CSA_1stYE extends AppCompatActivity {

    TextView showdate;
    ImageView sldate;
    int y,m,d;
    ActivityQaCsa1stYeBinding binding;
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_qa_csa1st_ye);
        binding = ActivityQaCsa1stYeBinding.inflate(getLayoutInflater());
        ...
        sldate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog g = new DatePickerDialog(QA_CSA_1stYE.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int y, int m, int d) {
                        ...
                        ListAdapter listAdapter = new ListAdapter(QA_CSA_1stYE.this, userArrayList);
                        ...
                        binding.listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                Intent i = new Intent(QA_CSA_1stYE.this, Userr_Activity.class);
