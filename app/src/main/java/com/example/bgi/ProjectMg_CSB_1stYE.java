...
import com.example.bgi.databinding.ActivityProjectMgCsb1stYeBinding;

import java.util.ArrayList;
import java.util.Calendar;

public class ProjectMg_CSB_1stYE extends AppCompatActivity {


    TextView showdate;
    ImageView sldate;
    int y,m,d;
    ActivityProjectMgCsb1stYeBinding binding;
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_project_mg_csb1st_ye);
        binding = ActivityProjectMgCsb1stYeBinding.inflate(getLayoutInflater());
        ...
        sldate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog g = new DatePickerDialog(ProjectMg_CSB_1stYE.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int y, int m, int d) {
                        ...
                        ListAdapter listAdapter = new ListAdapter(ProjectMg_CSB_1stYE.this, userArrayList);
                        ...
                        binding.listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                Intent i = new Intent(ProjectMg_CSB_1stYE.this, Userr_Activity.class);
