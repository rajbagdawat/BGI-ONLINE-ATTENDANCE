...
public class MachineLrn_CSA_1stYE extends AppCompatActivity {

    TextView showdate;
    ImageView sldate;
    int y,m,d;
    @SuppressLint("MissingInflatedId")
    ActivityMachineLrnCsa1stYeBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_machine_lrn_csa1st_ye);
        binding = ActivityMachineLrnCsa1stYeBinding.inflate(getLayoutInflater());
        ...
        sldate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog g = new DatePickerDialog(MachineLrn_CSA_1stYE.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        ListAdapter listAdapter = new ListAdapter(MachineLrn_CSA_1stYE.this, userArrayList);
        ...
        binding.listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(MachineLrn_CSA_1stYE.this, Userr_Activity.class);
