...
import com.example.bgi.databinding.ActivityCommuniCsa1stYeBinding;
import com.example.bgi.databinding.ActivityComputerGraphicsCsa1stYeBinding;

import java.util.ArrayList;
import java.util.Calendar;

public class Communi_CSA_1stYE extends AppCompatActivity {

    TextView showdate;
    ImageView sldate;
    int y,m,d;
    @SuppressLint("MissingInflatedId")
    ActivityCommuniCsa1stYeBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_communi_csa1st_ye);
        binding =  ActivityCommuniCsa1stYeBinding.inflate(getLayoutInflater());
        ...
        sldate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog g = new DatePickerDialog(Communi_CSA_1stYE.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int y, int m, int d) {
                        ...
                        ListAdapter listAdapter = new ListAdapter(Communi_CSA_1stYE.this, userArrayList);
                        ...
                        binding.listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                Intent i = new Intent(Communi_CSA_1stYE.this, Userr_Activity.class);
