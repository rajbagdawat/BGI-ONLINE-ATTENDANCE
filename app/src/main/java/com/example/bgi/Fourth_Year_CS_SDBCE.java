...
public class Fourth_Year_CS_SDBCE extends AppCompatActivity {

    Bundle bundle = new Bundle();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fourth_year_cs);
        CardView c1  = findViewById(R.id.CS_A_4sty_7Sem_cs);
        c1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String value1="f1";
                Intent intent = new Intent(Fourth_Year_CS_SDBCE.this, MainSubjectLayout.class);
...
//                intent1.putExtra("c1",value1);
        ...
        CardView c2 = findViewById(R.id.CS_B_4sty_7Sem_cs);
...
//                Bundle bundle = new Bundle();
        ...
        CardView c3  = findViewById(R.id.CS_A_4sty_8Sem_cs);
...
//                intent.putExtra("c3",value3);
        ...
        CardView c4 = findViewById(R.id.CS_B_4sty_8Sem_cs);
