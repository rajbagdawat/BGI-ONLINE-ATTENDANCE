...
import com.example.bgi.databinding.ActivityComputerGraphicsCsa1stYeBinding;
import com.example.bgi.databinding.ActivityComputerGraphicsCsb1stYeBinding;

import java.util.ArrayList;
import java.util.Calendar;

public class Computer_Graphics_CSB_1stYE extends AppCompatActivity {

    TextView showdate;
    ImageView sldate;
    int y,m,d;
    @SuppressLint("MissingInflatedId")
    ActivityComputerGraphicsCsb1stYeBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_computer_graphics_csb1st_ye);
        binding =  ActivityComputerGraphicsCsb1stYeBinding.inflate(getLayoutInflater());
        setContentView(R.layout.activity_computer_graphics_csa1st_ye);
        ...
        sldate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog g = new DatePickerDialog(Computer_Graphics_CSB_1stYE.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int y, int m, int d) {
                        ...
                        ListAdapter listAdapter = new ListAdapter(Computer_Graphics_CSB_1stYE.this, userArrayList);
                        ...
                        binding.listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                Intent i = new Intent(Computer_Graphics_CSB_1stYE.this, Userr_Activity.class);
