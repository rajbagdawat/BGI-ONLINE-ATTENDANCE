...
import com.example.bgi.databinding.ActivityComputerNetCsa1stYeBinding;

import java.util.ArrayList;
import java.util.Calendar;

public class ComputerNet_CSA_1stYE extends AppCompatActivity {

    TextView showdate;
    ImageView sldate;
    int y,m,d;
    ActivityComputerNetCsa1stYeBinding binding;
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_computer_net_csa1st_ye);
        binding = ActivityComputerNetCsa1stYeBinding.inflate(getLayoutInflater());
        ...
        sldate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog g = new DatePickerDialog(ComputerNet_CSA_1stYE.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int y, int m, int d) {
                        ...
                        ListAdapter listAdapter = new ListAdapter(ComputerNet_CSA_1stYE.this, userArrayList);
                        ...
                        binding.listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                Intent i = new Intent(ComputerNet_CSA_1stYE.this, Userr_Activity.class);
    ...
    public void back(View view){
        Intent intent = new Intent(this  , SDBCE_FirstY_CS_A_ListView.class);
