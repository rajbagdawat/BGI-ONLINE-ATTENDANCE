...
import com.example.bgi.databinding.ActivityComputerNetCsb1stYeBinding;

import java.util.ArrayList;
import java.util.Calendar;

public class ComputerNet_CSB_1stYE extends AppCompatActivity {


    TextView showdate;
    ImageView sldate;
    int y,m,d;
    ActivityComputerNetCsb1stYeBinding binding;
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_computer_net_csb1st_ye);
        binding =  ActivityComputerNetCsb1stYeBinding.inflate(getLayoutInflater());
        ...
        sldate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog g = new DatePickerDialog(ComputerNet_CSB_1stYE.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//                            userArrayList.add(user);
                        ...
                        ListAdapter listAdapter = new ListAdapter(ComputerNet_CSB_1stYE.this, userArrayList);
                        ...
                        binding.listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                Intent i = new Intent(ComputerNet_CSB_1stYE.this, Userr_Activity.class);
