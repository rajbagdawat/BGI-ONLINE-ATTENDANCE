...
import com.example.bgi.databinding.ActivityMachineLrnCsb1stYeBinding;

import java.util.ArrayList;
import java.util.Calendar;

public class MachineLrn_CSB_1stYE extends AppCompatActivity {
    ...
    ActivityMachineLrnCsb1stYeBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_machine_lrn_csa1st_ye);
        binding =  ActivityMachineLrnCsb1stYeBinding.inflate(getLayoutInflater());
        ...
        sldate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog g = new DatePickerDialog(MachineLrn_CSB_1stYE.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int y, int m, int d) {
                        ...
                        ListAdapter listAdapter = new ListAdapter(MachineLrn_CSB_1stYE.this, userArrayList);
                        ...
                        binding.listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                Intent i = new Intent(MachineLrn_CSB_1stYE.this, Userr_Activity.class);
